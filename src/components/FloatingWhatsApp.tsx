...
export const FloatingWhatsApp = () => {
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-24 left-6 md:bottom-8 md:left-8 z-40 bg-[#25D366] text-white p-4 rounded-full shadow-lg shadow-green-500/30 flex items-center justify-center cursor-pointer group"
        >
